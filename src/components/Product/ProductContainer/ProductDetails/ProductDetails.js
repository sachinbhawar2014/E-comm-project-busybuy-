    ...
    const handleRemove = async () => {
        try {
            ...
            if (cart && cart[productId]) {
                ...
                if (productCountAfterRemove === 0) return dispatch(filterProductFromCart({ productId }));
    ...
    return (
        <div className={styles.productDetails}>
            ...
            {!onCart ? (
                ...
                <button className={styles.removeBtn} title="Remove from Cart" onClick={removeProduct}>
